...
<div id="container">
<sf:form id="adv-add-form" action="${pageContext.request.contextPath}/ADD-ADVERTISEMENT"
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <sf:input path="engineVolume" type="text" placeholder="Enter engine volume in cc. For example 1600."/>
                <br>
